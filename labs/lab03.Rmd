...
#'
#' This function will assume that our data is linearly separable and return the vector that best separates our outputs with the least amount of error.
#'
#' @param Xinput      Features
#' @param y_binary    Outputs in binary form (0 or 1)
#' @param MAX_ITER    Maximum number of iterations that the algorithm performs
#' @param w           Bias
#'
...
This graph is showing that our data is linearly separable. 
...
-7 is the intercept of our line, 4 is our slope, and -1 is our weight.
...
It is not satisfying because it is not dividing the data evenly, as the line touches one of the orange values. 
...
Yes, the SVM is a better fit than the perceptron. 
