...
in_sample_error = sd(in_sample$residuals)
out_sample_yhat = predict(in_sample, data.frame(X_test))
out_sample_residual = y_test - out_sample_yhat
out_sample_error = sd(out_sample_residual)

in_sample_error #4.572195
out_sample_error #12.10467
# Therefore, out of sample error is greater 
```
...
in_sample_error_avg = in_sample_error/1000
out_sample_error_avg = out_sample_error/1000

in_sample_error_avg 
out_sample_error_avg
